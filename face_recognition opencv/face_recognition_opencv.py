...
# Face Recognition
#code implemented in virtual_env 
...
def detect(gray, frame): # We create a function that takes as input the image in black and white (gray) and the original image (frame), and that will return the same image with the detector rectangles. 
    ...
    for (x, y, w, h) in faces: # For each detected face: x and y cordinates of upper left corner, w is width and h is height for rectangles
  ...
  # doing facial recognition with webcam
